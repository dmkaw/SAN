...
import com.dmkaw.evi.estates.Building;
import com.dmkaw.evi.estates.BuildingType;
import com.dmkaw.evi.estates.CadastralMunicipality;
import com.dmkaw.evi.estates.LandLot;
import com.dmkaw.evi.ownership.Institution;
import com.dmkaw.evi.ownership.LandRegister;
import com.dmkaw.evi.ownership.Person;
...
public class TestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p1.setLlid("15/8");
		p1.setCadastralMunicipality(CadastralMunicipality.MŚCISZEWICE);
		p1.setArea(3861);
		...
		p2.setLlid("37/6");
		p2.setCadastralMunicipality(CadastralMunicipality.SUCHA);
		p2.setArea(1012);
